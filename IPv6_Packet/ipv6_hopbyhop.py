...
def calculate_checksum(data):
    ...
    if checksum == 0:
        ...
        return checksum
print('IPV6 packet\n');
print('0000  44 2a 60 f6 27 8a 00 0c  29 30 76 b5 86 dd 60 00 ')
...
print('0010  00 01 00 14 06 40 00 02  00 00 00 00 00 00 00 00 ')
...
print('0020  00 00 00 00 00 02 00 02  00 00 00 00 00 00 00 00 ')
class Header(object):
...
class ExtensionHeader(object):
    ...
    def _init_(self, next_header, hdr_ext_len=0):
...
print('0030  00 00 00 00 00 01 52 09  00 87 00 00 52 09 00 00 ')
class IPv6PseudoHeader(ConvertibleToBytes):
    ...
    def _init_(self, source_address, destination_address, payload_length,
                 next_header):
...
print('0040  00 00 50 02 40 38 cb 0a  00 00 ')
...
print("\n 0000  44 2a 60 f6 27 8a 00 0c 29 30 76 b5 86 dd 60 00"); 
print(" 0010  00 03 00 14 06 40 00 02  00 00 00 00 00 00 00 00"); 
print(" 0020  00 00 00 00 00 02 00 02  00 00 00 00 00 00 00 00 ");
print(" 0030  00 00 00 00 00 01 52 09  00 87 00 00 52 09 00 00"); 
print(" 0040  00 00 50 02 40 38 cb 0a  00 00"); 
  
print('\n After the Hop by Hop result is  : \n')
...
class UDPHeader(ConvertibleToBytes, BuildableFromBytes):
    ...
    def _init_(self, src_port, dst_port, payload_length=0, checksum=0):
...
print('0000  44 2a 60 f6 27 8a 00 0c  29 30 76 b5 86 dd 60 00 ')
print("0010  00 04 00 1c 00 40 00 02  00 00 00 00 00 00 00 00"); 
print("0020  00 00 00 00 00 02 00 02  00 00 00 00 00 00 00 00 ");
print("0030  00 00 00 00 00 01 06 00  00 00 00 00 00 00 52 0c"); 
print("0040  00 87 00 00 52 0c 00 00  00 00 50 02 40 38 cb 04");
print("0050  00 00") 
...
class UDPDatagram(UpperLayerProtocol):
    ...
    def _init_(self, header, payload):
        super(UDPDatagram, self)._init_(header)
...
class ICMPv6Header(ConvertibleToBytes, BuildableFromBytes):
    ...
    def _init_(self, _type, code, checksum=0):
        self.type = _type
        self.code = code
...
class ICMPv6(UpperLayerProtocol):
    ...
    def _init_(self, header, body):
        super(ICMPv6, self)._init_(header)
        self.body = body
...
class HopByHop(ExtensionHeader):
    ...
    def _init_(self, next_header=None, options=None, hdr_ext_len=None):
        super(HopByHop, self)._init_(next_header, hdr_ext_len)
...
class HopByHopOptionHeader(ConvertibleToBytes, BuildableFromBytes):
    ...
    def _init_(self, _type, length=None):
        self.type = _type
...
print('\nThe second header contains these eight bytes\n')
...
class MPLOption(ConvertibleToBytes):
    ...
    def _init_(self, S, M, V, sequence, seed_id):
        self.S = S
        self.M = M
        self.V = V
...
class IPv6PacketFactory(PacketFactory):
    ...
    def _init_(self, ehf=None, ulpf=None):
        """
...
class HopByHopOptionsFactory(object):
    ...
    def _init_(self, options_factories=None):
...
class HopByHopFactory(PacketFactory):
    ...
    def _init_(self, hop_by_hop_options_factory):
...
class UDPDatagramFactory(PacketFactory):
    ...
    def _init_(self, udp_header_factory, dst_port_factories=None):
        """
        Args:
...
class ICMPv6Factory(PacketFactory):
    ...
    def _init_(self, body_factories=None):
...
class ICMPv6EchoBody(ConvertibleToBytes, BuildableFromBytes):
    ...
    def _init_(self, identifier, sequence_number, data):
